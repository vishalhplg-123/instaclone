...
const Post = ({ post }) => {
  ...
  return (
    <div className="my-8 w-full max-w-sm mx-auto">
      <div className="flex item-center justify-between gap-2">
        ...
        <Dialog>
          ...
          <DialogContent className="flex flex-col items-center text-sm text-center">
            {
              post?.author?._id !== <button variant="ghost" className="cursor-pointer w-fit text-[#E04956] font-bold" > Unfollow </button>
             }
      ...
      <p>
        <span className="font-medium mt-2">{post?.author?.username} </span>
        {post?.caption}
      </p>
      {comment.length > 0 && (
        <span
