...
// //   // const craetePostHandler = async (e) => {
...
// //   //    try {
// //   //     setLoading(true);
// //   //      const res = await axios.post(`http://localhost:8000/v1/api/post/addpost`, formData, {
// //   //        headers: {
...
// //        <Button onClick={()=> imageRef.current.click()} className="w-fit mx-auto bg-[#0096F6] hover:bg-[#0095f6]">Select from computer</Button>
// //        {
// //         imagePreview && (
// //           loading ? (
// //             <Button>
...
// //             </Button>
// //           ) : (
// //              <Button onClick={craetePostHandler} type="submit" className="w-full">Post</Button>
// //           )
// //         )
// //        }
// //     </DialogContent>
...
//           <DialogDescription>
//             Share a photo and write a caption
//           </DialogDescription>
//         </DialogHeader>
